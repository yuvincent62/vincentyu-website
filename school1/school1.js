...
img.onload = function() {
  ...
  var pictureWidth = 1200; // Define the width of the picture
  var pictureHeight = 1150; // Define the height of the picture
  ctx.drawImage(img, 0, 0, pictureWidth, pictureHeight); // Draw the image with defined size
}
img.src = 'School1.png'; // Path to your image

// Function to open the popup
function openPopup(room) {
    var roomInfo = getRoomInfo(room);

//    console.log('temperature: ' + roomInfo.temperature);
